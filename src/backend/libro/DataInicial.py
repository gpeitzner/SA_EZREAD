...
db_password = os.environ["db_password"] if "db_password" in os.environ else "e91159a7917c3e14032fb0104296eb30"
...
db_user = os.environ["db_user"] if "db_user" in os.environ else "ezread"
